...
st.dataframe(pd.DataFrame(dt_result)) 
''')
kode(code24)
...
st.dataframe(pd.DataFrame(lr_result))
''')
kode(code25)
...
st.dataframe(pd.DataFrame(rf_result))
''')
kode(code26)
...
st.dataframe(pd.DataFrame(knn_result))
''')
kode(code27)
